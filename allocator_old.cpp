...
//base construction for allocator from example
...
//    auto m = std::map<int, int, std::less<int>, AllocatorForOtus<std::pair<const int, int>>>{};
    auto m = std::map<int, int>{};
    std::cout<<"typeis: " << typeid(m.get_allocator()).name() << std::endl;
//    m.reserve(10);
